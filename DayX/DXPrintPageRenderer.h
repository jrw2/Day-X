//
//  DXPrintPageRenderer.h
//  DayX
//
//  Created by James Westmoreland on 11/29/14.
...
@interface DXPrintPageRenderer : UIPrintPageRenderer

@property (nonatomic, readwrite) NSString *jobTitle;
